...
class NotificationCreate():
    ...
    :attr str ibmenpushto: (optional) This field should not be empty. The allowed
          ...
          then do not use fcm_devices / apns_devices / chrome_devices / firefox_devices
          with it.
    ...
    def __init__(self,
        ...
        :param str ibmenpushto: (optional) This field should not be empty. The
               ...
               user_ids are being used then do not use fcm_devices / apns_devices /
               chrome_devices / firefox_devices with it.
