# IBM Cloud Event Notifications Python Admin SDK 0.1.15
...
```bash
pip install --upgrade "ibm_eventnotifications>=0.1.15"
```
or
```bash
easy_install --upgrade "ibm_eventnotifications>=0.1.15"
```
