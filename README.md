# IBM Cloud Event Notifications Python Admin SDK 0.1.14
...
```bash
pip install --upgrade "ibm_eventnotifications>=0.1.14"
```
or
```bash
easy_install --upgrade "ibm_eventnotifications>=0.1.14"
```
