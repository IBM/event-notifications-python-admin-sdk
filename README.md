# IBM Cloud Event Notifications Python Admin SDK 0.24.0
...
```bash
pip install --upgrade "ibm_eventnotifications>=0.24.0"
```

or

```bash
easy_install --upgrade "ibm_eventnotifications>=0.24.0"
```
