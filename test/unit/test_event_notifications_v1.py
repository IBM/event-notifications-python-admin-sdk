...
class TestModel_SubscriptionAttributesPagerDutyAttributesResponse:
    ...
    def test_subscription_attributes_pager_duty_attributes_response_serialization(self):
        """
        Test serialization/deserialization for SubscriptionAttributesPagerDutyAttributesResponse
        """

        # Construct a json representation of a SubscriptionAttributesPagerDutyAttributesResponse model
        subscription_attributes_pager_duty_attributes_response_model_json = {}
        subscription_attributes_pager_duty_attributes_response_model_json['template_id_notification'] = 'testString'
        ...
        actual_dict = subscription_attributes_pager_duty_attributes_response_model.get_properties()
        assert actual_dict == {}

        expected_dict = {'foo': 'testString'}
        subscription_attributes_pager_duty_attributes_response_model.set_properties(expected_dict)
        actual_dict = subscription_attributes_pager_duty_attributes_response_model.get_properties()
        assert actual_dict == expected_dict
...
class TestModel_SubscriptionCreateAttributesPagerDutyAttributes:
    """
    Test Class for SubscriptionCreateAttributesPagerDutyAttributes
    """

    def test_subscription_create_attributes_pager_duty_attributes_serialization(self):
        """
        Test serialization/deserialization for SubscriptionCreateAttributesPagerDutyAttributes
        """

        # Construct a json representation of a SubscriptionCreateAttributesPagerDutyAttributes model
...
class TestModel_SubscriptionUpdateAttributesPagerDutyAttributes:
    """
    Test Class for SubscriptionUpdateAttributesPagerDutyAttributes
    """

    def test_subscription_update_attributes_pager_duty_attributes_serialization(self):
        """
        Test serialization/deserialization for SubscriptionUpdateAttributesPagerDutyAttributes
        """

        # Construct a json representation of a SubscriptionUpdateAttributesPagerDutyAttributes model
...
class TestModel_TemplateConfigOneOfPagerdutyTemplateConfig:
    """
    Test Class for TemplateConfigOneOfPagerdutyTemplateConfig
    """

    def test_template_config_one_of_pagerduty_template_config_serialization(self):
        """
        Test serialization/deserialization for TemplateConfigOneOfPagerdutyTemplateConfig
        """

        # Construct a json representation of a TemplateConfigOneOfPagerdutyTemplateConfig model
